...
<section class="w-full overflow-hidden dark:bg-gray-900">
    ...
    <div class="flex flex-col">
        ...
        <div class="sm:w-[60%] w-[90%] mx-auto flex">
            ...
            <h1
                class="w-full text-left my-4 sm:mx-4 pl-4 text-gray-400 lg:text-4xl md:text-3xl sm:text-3xl text-xl font-serif">
  ...
  <p class="md:text-lg leading-relaxed text-gray-400">Software is a great combination between artistry and engineering.</p>
